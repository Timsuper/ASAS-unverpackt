...
#define mfr
#include <HX711.h> //24-Bit A/D Wandler Wiegezelle
...
void loadcell_case_handler_test() {
  ...
  case 5: { // cmd: read-10
    ...
    if (loadcell_1.wait_ready_timeout(1000)) {
      ...
      wert_1 = loadcell_1.read_average(10);
    ...
    if (loadcell_2.wait_ready_timeout(1000)) {
      ...
      wert_2 = loadcell_2.read_average(10);
      Serial.println(wert_2/2);
    } else {
        Serial.println(">> HX711 Nr 2 nicht bereit");
    }
  ...
  case 7: { // cmd: get-value-10
    ...
    if (loadcell_1.wait_ready_timeout(1000)) {
      ...
      wert_1 = loadcell_1.get_value(10);
      Serial.println(wert_1/2);
    } else {
        Serial.println(">> HX711 Nr 1 nicht bereit");
    }
    if (loadcell_2.wait_ready_timeout(1000)) {
      ...
      wert_2 = loadcell_2.get_value(10);
      Serial.println(wert_2/2);
    } else {
        Serial.println(">> HX711 Nr 2 nicht bereit");
    }
  ...
  case 9: { // cmd: get-units-10
    ...
    if (loadcell_1.wait_ready_timeout(1000)) {
      ...
      wert_1 = loadcell_1.get_units(10);
      Serial.println(wert_1/2);
    } else {
        Serial.println(">> HX711 Nr 1 nicht bereit");
    }
    if (loadcell_2.wait_ready_timeout(1000)) {
      ...
      wert_2 = loadcell_2.get_units(10);
      Serial.println(wert_2/2);
    } else {
        Serial.println(">> HX711 Nr 2 nicht bereit");
    }
  ...
  case 10: { // cmd: set-scale-a
    ...
    if (str_3.indexOf("ja") > -1) {
      ...
      if (loadcell_1.wait_ready_timeout(1000) and loadcell_2.wait_ready_timeout(1000)) {
        Serial.println("");
        Serial.print(" -> loadcell_1.set_scale(");
        Serial.print(factor_1);
        Serial.println(")");
        Serial.print(" -> loadcell_2.set_scale(");
        Serial.print(factor_2);
        Serial.println(")");
        loadcell_1.set_scale(factor_1);
        loadcell_2.set_scale(factor_2);
      } else {
  ...
  case 12: { // cmd: set-offset
    ...
    if (str_3.indexOf("ja") > -1) {
      ...
      if (loadcell_1.wait_ready_timeout(1000) and loadcell_2.wait_ready_timeout(1000)) {
        ...
        Serial.print(offset);
        Serial.println(")");
        loadcell_1.set_offset(offset);
        loadcell_2.set_offset(offset);
      } else {
